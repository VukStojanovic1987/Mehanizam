...
namespace Mehanizam.Prava.Ugovori.Predmeti
{
    public partial class frmUredi : Form
    {
        ...
        {
            btnOtvori.Enabled = Properties.Settings.Default.UgovorPredmetPristupDirektorijumu;
        ...
        private void trePredmet_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Odabrana datoteka '" + Direktorijum + "\\" + e.Node.FullPath + "' je obrisana ili izmeštena sa lokacije.", "Prava - Ugovori", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
