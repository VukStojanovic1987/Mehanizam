...
namespace Mehanizam.Projektovanje.Katalozi.Predmeti
{
    public partial class frmUredi : Form
    {
        ...
        {
            btnOtvori.Enabled = Properties.Settings.Default.KatalogPredmetPristupDirektorijumu;
        ...
        private void trePredmet_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Odabrana datoteka '" + Direktorijum + "\\" + e.Node.FullPath + "' je obrisana ili izmeštena sa lokacije.", "Projektovanje - Katalozi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
