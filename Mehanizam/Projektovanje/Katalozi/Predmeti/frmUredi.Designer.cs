namespace Mehanizam.Projektovanje.Katalozi.Predmeti
{
    partial class frmUredi
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tipUredi.SetToolTip(this.btnOtvori, "Otvorite direktorijum kataloga.");
            this.btnOtvori.UseVisualStyleBackColor = true;
            this.btnOtvori.Click += new System.EventHandler(this.btnOtvori_Click);
            // 
            // tipUredi
            // 
            this.tipUredi.ToolTipTitle = "Projektovanje - Katalozi";
            // 
            ...
            this.Text = "Projektovanje - Katalog - Obrada";
