namespace Mehanizam.Projektovanje.Katalozi.Predmeti
{
    partial class frmPregled
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblNaslov.Text = "Projektovanje - Katalozi";
            ...
            this.tipPregled.SetToolTip(this.btnObrisi, "Obrišite odabrani katalog.");
            ...
            this.tipPregled.SetToolTip(this.btnUredi, "Uredite odabrani katalog.");
            ...
            this.tipPregled.SetToolTip(this.btnDodaj, "Dodajte novi katalog.");
            ...
            this.Text = "Projektovanje - Katalozi";
