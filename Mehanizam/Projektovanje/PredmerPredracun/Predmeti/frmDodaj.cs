...
namespace Mehanizam.Projektovanje.PredmerPredracun.Predmeti
{
    public partial class frmDodaj : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Dirktorijum za predmer i predračun radova nije podešen.", "Mehanizam", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            if (!Directory.Exists(Properties.Settings.Default.PredmerPredracunDirektorijum))
            {
                MessageBox.Show("Podešeni dirktorijum '" + Properties.Settings.Default.PredmerPredracunDirektorijum + "' je obrisan ili izmešten sa lokacije.", "Mehanizam", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void NapraviPredmet()
        {
            ...
            string Putanja = Properties.Settings.Default.PredmerPredracunDirektorijum + "\\" + Naziv;
            ...
            File.WriteAllBytes(Putanja + "\\Predmer i predračun radova.xlsm", Properties.Resources.PredmerPredracun);
