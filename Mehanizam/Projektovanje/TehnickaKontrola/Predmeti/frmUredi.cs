...
namespace Mehanizam.Projektovanje.TehnickaKontrola.Predmeti
{
    public partial class frmUredi : Form
    {
        ...
        {
            btnOtvori.Enabled = Properties.Settings.Default.RevizijaPredmetPristupDirektorijumu;
        ...
        private void trePredmet_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Odabrana datoteka '" + Direktorijum + "\\" + e.Node.FullPath + "' je obrisana ili izmeštena sa lokacije.", "Mehanizam", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
