...
namespace Mehanizam.Projektovanje.TehnickaKontrola.Predmeti
{
    public partial class frmDodaj : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Dirktorijum za tehničke kontrole nije podešen.", "Mehanizam", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            if (!Directory.Exists(Properties.Settings.Default.RevizijaDirektorijum))
            {
                MessageBox.Show("Podešeni dirktorijum '" + Properties.Settings.Default.RevizijaDirektorijum + "' je obrisan ili izmešten sa lokacije.", "Mehanizam", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void NapraviPredmet()
        {
            ...
            string Putanja = Properties.Settings.Default.RevizijaDirektorijum + "\\" + Naziv;
            ...
            File.WriteAllBytes(Putanja + "\\Tehnička kontrola projekta.xlsm", Properties.Resources.TehnickaKontrola);
