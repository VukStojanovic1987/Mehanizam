    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Tip objekta")
                {
                    return "TipObjekta";
                }
                else if (cmbKolona.Text == "Naziv objekta")
                {
                    return "NazivObjekta";
                }
                else if (cmbKolona.Text == "Naziv objekta iz konteksta")
                {
                    return "NazivObjektaIzKonteksta";
                }
                else if (cmbKolona.Text == "Kategorija objekta")
                {
                    return "KategorijaObjekta";
                }
                else if (cmbKolona.Text == "Klasifikaciona oznaka")
                {
                    return "KlasifikacionaOznaka";
                }
                else if (cmbKolona.Text == "Objašnjenje")
                {
                    return "Objasnjenje";
                }
                else
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblListaObjekataPoPravilnikuKlasifikacija.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Tip objekta";
                dgvPregled.Columns[2].HeaderText = "Naziv objekta";
                dgvPregled.Columns[3].HeaderText = "Naziv objekta iz konteksta";
                dgvPregled.Columns[4].HeaderText = "Kategorija objekta";
                dgvPregled.Columns[5].HeaderText = "Klasifikaciona oznaka";
                dgvPregled.Columns[6].HeaderText = "Objašnjenje";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryTipoviObjekataPregled");
