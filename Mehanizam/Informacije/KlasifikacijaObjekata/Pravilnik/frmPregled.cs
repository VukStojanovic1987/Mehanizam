...
namespace Mehanizam.Informacije.KlasifikacijaObjekata.Pravilnik
{
    public partial class frmPregled : Form
    {
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblPravilnikKlasifikacija.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[2].HeaderText = "Kategorija objekta";
                dgvPregled.Columns[3].HeaderText = "Klasifikaciona oznaka";
                dgvPregled.Columns[4].HeaderText = "Objašnjenje";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryPravilnikKlasifikacijaPregled");
