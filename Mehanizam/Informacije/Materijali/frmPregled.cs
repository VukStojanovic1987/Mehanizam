    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Namena materijala")
                {
                    return "Namena";
                }
                else if (cmbKolona.Text == "Naziv materijala")
                {
                    return "Naziv";
                }
                else
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblMaterijali.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Namena materijala";
                dgvPregled.Columns[2].HeaderText = "Naziv materijala";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryMaterijaliPregled");
