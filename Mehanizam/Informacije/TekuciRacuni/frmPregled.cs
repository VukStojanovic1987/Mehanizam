...
namespace Mehanizam.Informacije.TekuciRacuni
{
    public partial class frmPregled : Form
    {
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblTekuciRacuni.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Lice";
                dgvPregled.Columns[2].HeaderText = "Banka";
                dgvPregled.Columns[3].HeaderText = "Tekuci račun";
                dgvPregled.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryTekuciRacuniPregled");
