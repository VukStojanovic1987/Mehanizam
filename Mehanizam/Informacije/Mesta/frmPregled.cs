...
namespace Mehanizam.Informacije.Mesta
{
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Okrug")
                {
                    return "Okrug";
                }
                else if (cmbKolona.Text == "Opština")
                {
                    return "Opstina";
                }
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblMesta.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Okrug";
                dgvPregled.Columns[2].HeaderText = "Opština";
                dgvPregled.Columns[3].HeaderText = "Mesto";
                dgvPregled.Columns[4].HeaderText = "Poštanski broj";
                dgvPregled.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryMestaPregled");
