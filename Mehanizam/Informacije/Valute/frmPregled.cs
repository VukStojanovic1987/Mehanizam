    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Valuta")
                {
                    return "Valuta";
                }
                else if (cmbKolona.Text == "Skraćenica")
                {
                    return "Skracenica";
                }
                else
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblValute.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Valuta";
                dgvPregled.Columns[2].HeaderText = "Skraćenica";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM Valute");
        ...
        private void OsveziTabelu()
        {
            ...
            if (Greska == true)
            {
                MessageBox.Show(Poruke.GreskaBaza, Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
