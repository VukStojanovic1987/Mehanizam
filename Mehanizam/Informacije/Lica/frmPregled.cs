...
namespace Mehanizam.Informacije.Lica
{
    public partial class frmPregled : Form
    {
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblLica.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void btnEmail_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Poruke.PilotZapisaRed, Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            Cursor.Current = Cursors.WaitCursor;

            clsPismo Pismo = new clsPismo(Convert.ToInt64(dgvPregled.CurrentRow.Cells[0].Value));
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[6].HeaderText = "Ulica i broj";
                dgvPregled.Columns[7].HeaderText = "Odgovorno lice";
                dgvPregled.Columns[8].HeaderText = "Email";
                dgvPregled.Columns[8].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryLicaPregled");
