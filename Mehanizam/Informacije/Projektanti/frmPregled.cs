...
namespace Mehanizam.Informacije.Projektanti
{
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Ime i prezime")
                {
                    return "ImeNaziv";
                }
                else if (cmbKolona.Text == "Zvanje")
                {
                    return "Zvanje";
                }
                else if (cmbKolona.Text == "Tip licence")
                {
                    return "TipLicence";
                }
                else if (cmbKolona.Text == "Broj licence")
                {
                    return "BrojLicence";
                }
                else
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblProjektanti.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Ime i prezime";
                dgvPregled.Columns[2].HeaderText = "Zvanje";
                dgvPregled.Columns[3].HeaderText = "A";
                dgvPregled.Columns[4].HeaderText = "K";
                dgvPregled.Columns[5].HeaderText = "H";
                dgvPregled.Columns[6].HeaderText = "E";
                dgvPregled.Columns[7].HeaderText = "TS";
                dgvPregled.Columns[8].HeaderText = "M";
                dgvPregled.Columns[9].HeaderText = "Tip licence";
                dgvPregled.Columns[10].HeaderText = "Broj licence";
                dgvPregled.Columns[10].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryProjektantiPregled");
