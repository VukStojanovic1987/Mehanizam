...
namespace Mehanizam.Informacije.PredmerPredracun
{
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Naziv rada")
                {
                    return "NazivRada";
                }
                else if (cmbKolona.Text == "Naziv podrada")
                {
                    return "NazivPodrada";
                }
                else if (cmbKolona.Text == "Naziv pozicije")
                {
                    return "NazivPozicije";
                }
                else if (cmbKolona.Text == "Opis pozicije")
                {
                    return "OpisPozicije";
                }
                else if (cmbKolona.Text == "Jedinica mere")
                {
                    return "JedinicaMere";
                }
                else if (cmbKolona.Text == "Projektanska cena")
                {
                    return "ProjektanskaCena";
                }
                else
                {
                    return "";
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblInformacijePredmeriPredracuni.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Radovi ID";
                dgvPregled.Columns[2].HeaderText = "Naziv rada";
                dgvPregled.Columns[3].HeaderText = "Redosled podrada";
                dgvPregled.Columns[4].HeaderText = "Naziv podrada";
                dgvPregled.Columns[5].HeaderText = "Redosled pozicije";
                dgvPregled.Columns[6].HeaderText = "Naziv pozicije";
                dgvPregled.Columns[7].HeaderText = "Opis pozicije";
                dgvPregled.Columns[8].HeaderText = "Jedinica mere";
                dgvPregled.Columns[9].HeaderText = "Projektanska cena";

                dgvPregled.Columns[1].Visible = false;
                dgvPregled.Columns[3].Visible = false;
                dgvPregled.Columns[5].Visible = false;
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryPredmeriPredracuniPregled");
