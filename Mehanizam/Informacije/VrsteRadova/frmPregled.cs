    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Vrsta radova")
                {
                    return "VrstaRadova";
                }
                else if (cmbKolona.Text == "Vrsta radova iz konteksta")
                {
                    return "VrstaRadovaIzKonteksta";
                }
                else
                {
                    return "";
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblVrsteRadova.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Vrsta radova";
                dgvPregled.Columns[2].HeaderText = "Vrsta radova iz konteksta";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryVrsteRadovaPregled");
