...
namespace Mehanizam.Informacije.JediniceMere
{
    public partial class frmPregled : Form
    {
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblJediniceMere.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Jedinica mere";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryJediniceMerePregled");
