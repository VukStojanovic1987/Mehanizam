    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Naziv prostorije")
                {
                    return "Naziv";
                }
                else
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblNameneProstorija.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Naziv prostorije";
        ...
        private void PopuniTabeluBP()
        {
            ...
            AccessBP.IzvrsiUpit("SELECT * FROM qryNameneProstorijaPregled");
