...
namespace Mehanizam.Finansije.Racuni
{
    public partial class frmUredi : Form
    {
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            if (PraznaPolja() == true)
            {
                MessageBox.Show(Poruke.ObaveznaPolja, "Finansije - Računi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void Ucitaj()
        {
            if (ID == 0)
            {
                MessageBox.Show(Poruke.GreskaIdNula, "Finansije - Računi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show(Poruke.GreskaBrojZapisaNijeJedan, "Finansije - Računi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
