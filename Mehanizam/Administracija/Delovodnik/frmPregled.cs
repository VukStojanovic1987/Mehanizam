    ...
    public partial class frmPregled : Form
    {
        ...
        private string Kolona
        {
            get
            {
                ...
                else if (cmbKolona.Text == "Datum zavođenja dokumenta")
                {
                    return "DatumZavodjenja";
                }
                else if (cmbKolona.Text == "Evidencioni broj")
                {
                    return "EvidencioniBroj";
                }
                else if (cmbKolona.Text == "Mesto zavođenja dokumenta")
                {
                    return "MestoZavodjenja";
                }
                else if (cmbKolona.Text == "Vrsta dokumenta")
                {
                    return "VrstaDokumenta";
                }
                else if (cmbKolona.Text == "Izlazni/Ulazni dokument")
                {
                    return "IzlazniUlazni";
                }
                else if (cmbKolona.Text == "Opis dokumenta")
                {
        ...
        private void frmPregled_Load(object sender, EventArgs e)
        {
            ...
            btnAccess.Enabled = Properties.Settings.Default.DelovodnikPristupBazi;
        ...
        private void btnZatvori_Click(object sender, EventArgs e)
        {
            ...
            frmIndexInstanca.lblDelovodnik.ForeColor = Color.Silver;
            Close();
            Dispose();
        }
        ...
        private void btnUredi_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Poruke.ObradaZapisaRed, "Administracija - Delovodnik", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void btnObrisi_Click(object sender, EventArgs e)
        {
            if (dgvPregled.CurrentRow == null)
            {
                MessageBox.Show(Poruke.BrisanjeZapisaRed, "Administracija - Delovodnik", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            if (MessageBox.Show(Poruke.BrisanjeZapisaPitanje, "Administracija - Delovodnik", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No) { return; }
            ...
            AccessBP.IzvrsiUpit("DELETE FROM tblDelovodnik WHERE ID=@ID");
        ...
        private void DgvAzuriraj()
        {
            ...
            try
            {
                ...
                dgvPregled.Columns[1].HeaderText = "Datum zavođenja dokumenta";
                dgvPregled.Columns[2].HeaderText = "Evidencioni broj";
                dgvPregled.Columns[3].HeaderText = "Mesto zavođenja dokumenta";
                dgvPregled.Columns[4].HeaderText = "Vrsta dokumenta";
                dgvPregled.Columns[5].HeaderText = "Izlazni/Ulazni dokument";
                dgvPregled.Columns[6].HeaderText = "Opis dokumenta";

                dgvPregled.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        ...
        {
            if (string.IsNullOrWhiteSpace(Properties.Settings.Default.DelovodnikBaza))
            {
                MessageBox.Show(Poruke.PutanjaBazeNijePodesena, "Administracija - Delovodnik", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            if (!File.Exists(Properties.Settings.Default.DelovodnikBaza))
            {
                MessageBox.Show(Poruke.DatotekaNijePronadjena(Properties.Settings.Default.DelovodnikBaza), "Administracija - Delovodnik", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            Cursor.Current = Cursors.WaitCursor;

            System.Diagnostics.Process.Start(Properties.Settings.Default.DelovodnikBaza);
